...
5. Run `npm run ci`, present results and proposed commit message.
6. Ask: _"Do you want me to commit and close the story?"_
7. On approval: `HUSKY=0 git commit` for the implementation, then a separate
