...
| STORY-0028 | fix      | OPEN   | Fix compiler errors and missing useEffect deps in IsolinePage | unassigned |                                                                                                                     |
| STORY-0027 | refactor | OPEN   | Tighten Route.transportMode to the TransportMode enum         | unassigned |                                                                                                                     |
| STORY-0026 | fix      | OPEN   | Cancel stale fetch requests on dependency change              | unassigned |                                                                                                                     |
