...
| ---------- | ------ | ----------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------- |
| STORY-0021 | OPEN   | Mobile fullscreen dialog pages                  | unassigned | Replace modal dialogs with fullscreen pages + back button on mobile; keep desktop modals unchanged              |
